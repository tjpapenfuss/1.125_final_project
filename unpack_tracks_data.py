...
imported_df_edm = pd.read_csv("athena_build/data/edm_playlist_tracks_data.csv")
imported_df_indie = pd.read_csv("athena_build/data/indie_playlist_tracks_data.csv")
imported_df_jazz = pd.read_csv("athena_build/data/Jazz_playlist_tracks_data.csv")

df_indie_pl = pd.read_csv("athena_build/data/indie_playlist_data.csv")
df_jazz_pl = pd.read_csv("athena_build/data/Jazz_playlist_data.csv")
df_edm_pl = pd.read_csv("athena_build/data/edm_playlist_data.csv")
...
imported_df_edm.to_csv("athena_build/data/edm_playlist_tracks_data.csv")
imported_df_indie.to_csv("athena_build/data/indie_playlist_tracks_data.csv")
imported_df_jazz.to_csv("athena_build/data/Jazz_playlist_tracks_data.csv")

df_indie_pl.to_csv("athena_build/data/indie_playlist_data.csv")
df_jazz_pl.to_csv("athena_build/data/Jazz_playlist_data.csv")
df_edm_pl.to_csv("athena_build/data/edm_playlist_data.csv")
