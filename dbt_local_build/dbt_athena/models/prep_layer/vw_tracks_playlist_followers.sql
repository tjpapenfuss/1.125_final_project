...
FROM "raw_data_spotify_dataset"."spotify_edm_playlist_tracks_data_csv_bucket" t1  
LEFT JOIN "raw_data_spotify_dataset"."spotify_edm_playlist_data_csv_bucket" t2
